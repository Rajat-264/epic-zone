      ...
      <div className="admin-list">
        {businesses.map(b => (
          <div key={b._id} className="admin-card">
            {b.mainImage && (
              <img src={b.mainImage} alt={b.name} className="admin-image" />
            )}
            ...
            <div className="admin-actions">
              <button className="approve" onClick={() => updateStatus(b._id, 'approved')}>Approve</button>
              <button className="reject" onClick={() => updateStatus(b._id, 'rejected')}>Reject</button>
            </div>
          </div>
        ))}
      </div>
